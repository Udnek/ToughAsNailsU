    ...
    public void afterInit(InitializationEvent event){
        ...
        if (event.getStep() == InitializationProcess.Step.BEFORE_VANILLA_MANAGER) {
            ...
            replacedLeatherChestplate.setComponent(
                    new CustomItemAttributesComponent(
                            new CustomAttributesContainer.Builder()
                                    .add(Attributes.COLD_RESISTANCE, 0.15, AttributeModifier.Operation.ADD_SCALAR, CustomEquipmentSlot.CHEST)
                                    .build()
                    )
            );
            ...
            replacedLeatherHelmet.setComponent(
                    new CustomItemAttributesComponent(
                            new CustomAttributesContainer.Builder()
                                    .add(Attributes.COLD_RESISTANCE, 0.15, AttributeModifier.Operation.ADD_SCALAR, CustomEquipmentSlot.HEAD)
                                    .build()
                    )
            );
            ...
            replacedLeatherLeggings.setComponent(
                    new CustomItemAttributesComponent(
                            new CustomAttributesContainer.Builder()
                                    .add(Attributes.COLD_RESISTANCE, 0.15, AttributeModifier.Operation.ADD_SCALAR, CustomEquipmentSlot.LEGS)
                                    .build()
                    )
            );
            ...
            replacedLeatherBoots.setComponent(
                    new CustomItemAttributesComponent(
                            new CustomAttributesContainer.Builder()
                                    .add(Attributes.COLD_RESISTANCE, 0.15, AttributeModifier.Operation.ADD_SCALAR, CustomEquipmentSlot.FEET)
                                    .build()
                    )
            );
            ...
            replacedChainmailChestplate.setComponent(
                    new CustomItemAttributesComponent(
                            new CustomAttributesContainer.Builder()
                                    .add(Attributes.HEAT_RESISTANCE, 0.15, AttributeModifier.Operation.ADD_SCALAR, CustomEquipmentSlot.CHEST)
                                    .build()
                    )
            );
            ...
            replacedChainmailHelmet.setComponent(
                    new CustomItemAttributesComponent(
                            new CustomAttributesContainer.Builder()
                                    .add(Attributes.HEAT_RESISTANCE, 0.15, AttributeModifier.Operation.ADD_SCALAR, CustomEquipmentSlot.HEAD)
                                    .build()
                    )
            );
            ...
            replacedChainmailLeggings.setComponent(
                    new CustomItemAttributesComponent(
                            new CustomAttributesContainer.Builder()
                                    .add(Attributes.HEAT_RESISTANCE, 0.15, AttributeModifier.Operation.ADD_SCALAR, CustomEquipmentSlot.LEGS)
                                    .build()
                    )
            );
            ...
            replacedChainmailBoots.setComponent(
                    new CustomItemAttributesComponent(
                            new CustomAttributesContainer.Builder()
                                    .add(Attributes.HEAT_RESISTANCE, 0.15, AttributeModifier.Operation.ADD_SCALAR, CustomEquipmentSlot.FEET)
                                    .build()
                    )
            );
        }
