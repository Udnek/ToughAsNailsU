...
public class Attributes {
    ...
    public static final CustomAttribute COLD_RESISTANCE = register(
            new ConstructableCustomAttribute("cold_resistance", "attribute.toughasnailsu.name.cold_resistance", 1,0, 2));
    public static final CustomAttribute HEAT_RESISTANCE = register(
            new ConstructableCustomAttribute("heat_resistance", "attribute.toughasnailsu.name.heat_resistance", 1,0, 2));
